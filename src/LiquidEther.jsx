  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      update() {
        ...
        // Keep diff unscaled for linear, frame-time-normalized force downstream
      }
    }
...
`
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props) {
        const invDt = 1 / Math.max(Common.delta || 0.016, 1 / 120)
        const vx = Mouse.diff.x * invDt
        const vy = Mouse.diff.y * invDt
        const forceX = vx * props.mouse_force
        const forceY = vy * props.mouse_force
